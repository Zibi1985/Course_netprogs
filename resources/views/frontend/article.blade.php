...
@section('content')
    <div class="container">
        ...
        <h1>Artykuł <small>nt obiektu: <a href="{{ route('object') }}">X</a></small></h1>
        ...
        <a class="btn btn-primary top-buffer" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
            Lubią ten artykuł <span class="badge">10</span>
        </a>
        ...
        <a href="#" class="btn btn-primary btn-xs">Polub artykuł</a><br><br>
